        ...
        <div className="min-h-screen flex items-center justify-center">
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8">
                ...
                <div className="bg-white shadow-md rounded px-4 sm:px-8 py-6 flex flex-col items-center w-full sm:w-1/2">
                    ...
                    <Link href="/login" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full">
                        Iniciar Sesión
                    </Link>
                </div>
                ...
                <div className="bg-white shadow-md rounded px-4 sm:px-8 py-6 flex flex-col items-center w-full sm:w-1/2">
                    ...
                    <Link href="/login-barberia" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full">
                        Iniciar Sesión
                    </Link>
                </div>
            </div>
